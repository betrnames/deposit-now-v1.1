...
export function WhyDepositNow({ showPricingLink = true }: { showPricingLink?: boolean }) {
  return (
    <section className="pt-16 pb-24 sm:pt-24 sm:pb-32 bg-slate-950/60 border-t border-blue-500/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
          ...
          <div className="min-w-0 order-1 lg:order-2">
            <p className="text-base sm:text-lg text-blue-400 font-medium mb-6 leading-relaxed">
            ...
            {showPricingLink && (
              <div className="flex flex-col sm:flex-row items-stretch gap-3 sm:gap-4 w-full">
                <Link
                  href="/pricing"
                  className="inline-flex items-center justify-center w-full sm:flex-1 bg-blue-600 hover:bg-blue-700 text-white font-black text-[10px] uppercase tracking-wider px-8 h-12 rounded-xl transition-colors"
                >
                  Merchant pricing
                </Link>
                <Link
                  href="/litepaper"
                  className="inline-flex items-center justify-center w-full sm:flex-1 border border-blue-500/40 bg-blue-500/5 hover:bg-blue-500/10 text-blue-400 hover:text-blue-300 font-black text-[10px] uppercase tracking-wider px-8 h-12 rounded-xl transition-colors"
                >
                  Litepaper
                </Link>
              </div>
